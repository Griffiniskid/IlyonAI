# Static sweep — passA-wave7

Scanned: 532 turn files
Files with ≥1 hit: 92
Total pattern hits: 174

## Top patterns (by file count)

| ID | Sev | Files | Hits | Description |
|----|-----|-------|------|-------------|
| AP-140 | P1 | 71 | 152 | 40-hex address (verify if backed by card or freeform) |
...
| AP-190 | P0 | 4 | 4 | Backticked Solidity call signatures (H14 t3/t4) |
| AP-170 | P0 | 2 | 2 | Card 'status:ready' with 'transaction:null' (composed-plan E07 t4, H06) |
| AP-100 | P0 | 1 | 1 | '**Policy Signed**' fabricated signature state (I02 t3) |
...
| B | 8 | AP-050 (5 files) |
| C | 8 | AP-140 (8 files) |
| D | 11 | AP-140 (11 files) |
| E | 13 | AP-140 (11 files) |
| F | 5 | AP-140 (4 files) |
| G | 10 | AP-140 (9 files) |
| H | 13 | AP-140 (11 files) |
| I | 4 | AP-130 (3 files) |
| e | 4 | AP-190 (3 files) |
...
- `B10_pendle_pt\turn_2.txt`: `"content":"","card_ids":[]`
- `E10_eth_to_base_eth_native\turn_2.txt`: `"content":"","card_ids":[]`
- `enso-10\turn_3.txt`: `"content":"","card_ids":[]`
- `F09_null_route\turn_3.txt`: `"content":"","card_ids":[]`
