# Static sweep — passA-wave11

Scanned: 532 turn files
Files with ≥1 hit: 87
Total pattern hits: 186

## Top patterns (by file count)

| ID | Sev | Files | Hits | Description |
|----|-----|-------|------|-------------|
| AP-140 | P1 | 87 | 186 | 40-hex address (verify if backed by card or freeform) |
...
| D | 10 | AP-140 (10 files) |
| E | 18 | AP-140 (18 files) |
| F | 5 | AP-140 (5 files) |
| G | 13 | AP-140 (13 files) |
...
- `A06_morpho_blue\turn_3.txt` — 3 hits — AP-140
...
- `C05_velodrome_cl\turn_2.txt` — 3 hits — AP-140
- `C08_morpho_blue_market\turn_2.txt` — 3 hits — AP-140
- `C09_yearn_v3_usdc\turn_3.txt` — 3 hits — AP-140
...
- `A05_yearn_eth_vault\turn_3.txt`: `0x833589fcd6edb6e08f4c7c32d4f71b54bda02913`
