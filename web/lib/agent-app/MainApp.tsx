...
export default function MainApp() {
  ...
  const [activeTab, setActiveTab]       = useState<Tab>(() => {
    ...
    if (p.startsWith("/agent/chat")) return "chat";
    if (p.startsWith("/agent/swap")) return "swap";
    if (p.startsWith("/agent/portfolio") || p.startsWith("/portfolio")) return "portfolio";
    return "dashboard";
  });
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === "chat" && (
                <motion.div key="chat" className="chat-wrap" variants={slideIn} initial="hidden" animate="show">
                  <div className="page-shell" style={{ maxWidth: "none", paddingTop: 0, height: "100%", display: "flex", flexDirection: "column" }}>
              ...
              {activeTab === "swap" && (
                <motion.div key="swap" variants={scaleIn} initial="hidden" animate="show" style={{ flex: 1, overflowY: "auto", padding: "24px 24px 40px" }}>
                  <div className="page-shell" style={{ display: "grid", gridTemplateColumns: "minmax(0, 1.15fr) minmax(280px, 0.85fr)", gap: 18, alignItems: "start" }}>
                    <div style={{
                      background: "rgba(15,23,42,0.72)",
                      border: "1px solid rgba(255,255,255,0.08)",
                      borderRadius: 24,
