...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: "/api/v1/agent/sessions", destination: `${assistantTarget}/api/v1/agent/sessions` },
      { source: "/api/v1/agent/sessions/:path*", destination: `${assistantTarget}/api/v1/agent/sessions/:path*` },
