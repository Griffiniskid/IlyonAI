...
EVM_ENSO_EXEC_PROTOCOLS = frozenset(
    ...
    | {
        ...
        "stader",
        "gmx",
        "velodrome", "velodrome-v1", "velodrome-v2", "velodrome-v3", "velodrome-finance",
        "aerodrome", "aerodrome-v1", "aerodrome-finance",
...
def is_pool_link_action(*, action: str | None, protocol: str | None, chain: str | None = None) -> bool:
    ...
    # V3 EVM executes natively via UniswapV3NFTAdapter. As of commit
    # 4554382 the v3_pool_resolver speaks both the Uniswap-style
